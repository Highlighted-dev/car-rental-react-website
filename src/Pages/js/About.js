        ...
        <div id="about">
            ...
            <div id="about-us">
                ...
                <div id="about-us-text">
                    <h3>About us</h3>
                    <label>Rentoro is proud to serve customers in Poland. As part of the largest rental car company in the country, which owns and operates more than 3 thousand vehicles, we’re sure to have a location near you or your travel destination. And while we are an internationally recognized brand, Rentoro remains family-owned with one goal in mind for our customers: to exceed your expectations for service and overall value.</label><br /><br />
